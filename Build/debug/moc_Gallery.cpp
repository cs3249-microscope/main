...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Gallery_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Gallery_t qt_meta_stringdata_Gallery = {
    {
QT_MOC_LITERAL(0, 0, 7), // "Gallery"
QT_MOC_LITERAL(1, 8, 17), // "imageDepthChanged"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 16), // "changeImageDepth"
QT_MOC_LITERAL(4, 44, 16) // "QListWidgetItem*"

    },
    "Gallery\0imageDepthChanged\0\0changeImageDepth\0"
    "QListWidgetItem*"
};
...
void Gallery::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Gallery *_t = static_cast<Gallery *>(_o);
        switch (_id) {
        case 0: _t->imageDepthChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->changeImageDepth((*reinterpret_cast< QListWidgetItem*(*)>(_a[1])),(*reinterpret_cast< QListWidgetItem*(*)>(_a[2]))); break;
        ...
        {
            typedef void (Gallery::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Gallery::imageDepthChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Gallery::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Gallery.data,
      qt_meta_data_Gallery,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Gallery::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Gallery.stringdata))
...
// SIGNAL 0
void Gallery::imageDepthChanged(int _t1)
{
