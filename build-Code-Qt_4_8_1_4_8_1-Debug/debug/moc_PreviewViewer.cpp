...
static const char qt_meta_stringdata_PreviewViewer[] = {
    "PreviewViewer\0"
};
...
const QMetaObjectExtraData PreviewViewer::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject PreviewViewer::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_PreviewViewer,
      qt_meta_data_PreviewViewer, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &PreviewViewer::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PreviewViewer))
